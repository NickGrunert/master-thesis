...
#let conclusion() = {
  text(lang:"en")[
    ...
    This thesis constituted an exploration of the potential of computer vision techniques to extract geometric features from nDSM data.
    A set of key methods was subjected to empirical evaluation in order to ascertain their effectiveness in identifying fine-grained structural elements of building roofs with a view to supporting precise segmentation. The methods evaluated included edge detection, segmentation and morphological operations.
    ...
    The quality of resulting segmentations was assessed through custom evaluation metrics based on geometric properties. 
    ...
    The performance of SAM was evaluated using high quality input prompts generated by the proposed pipeline and compared to manually defined and automatically generated prompts.
    ...
    It is recommended that further investigation be conducted into the various strategies that have been established in this study for prompting SAM via input points.
    This is particularly evident in the context of negative prompts, which remain under-explored but hold untapped potential for improving segmentation precision.
    ...
    A more sophisticated approach should be formulated in order to identify the most valuable negative inputs, as opposed to the approach that has been employed in this instance.
    ...
    It is suggested that future research in this field might develop a classification system for roof types based on the segmentations generated in this study.
