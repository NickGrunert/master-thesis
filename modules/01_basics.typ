...
#let basics(abr) = {
  text(lang:"en")[
    ...
    The extraction of building structures is heavily reliant on the utilisation of #abr("DSM") data, as it contains pivotal information regarding the height of buildings and other objects on the surface @extractUAV.
    ...
    A multitude of potential error sources have been identified, including the #abr("DSM") and #abr("DEM") being recorded not at the same time, the utilisation of disparate sensors, and inherent inaccuracies in these sensors.
