...
#let intro(abr) = {
  text(lang:"en")[
    ...
    RSAM-Seg @intro12 is an exemplar of a model that incorporates lightweight adapter modules within #abr("SAM"), meticulously calibrated using remote sensing data.
    ...
    Integration with Other Models: The utilization of output masks generated by #abr("SAM") has been demonstrated in the context of multi-scale segmentation algorithms. 
    ...
    This work incorporated a variety of tools in each of its aspects.
